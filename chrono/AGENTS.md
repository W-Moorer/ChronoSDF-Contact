...
This local fork was hard-trimmed to the minimal Chrono multibody framework. References below to optional modules, demos, tests, and extended templates describe the upstream repository layout, not the reduced layout in this workspace.
